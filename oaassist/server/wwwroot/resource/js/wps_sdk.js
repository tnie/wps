(function (global, factory) {
        ...
        var askItem = function () {
            ...
            xhr.onload = function (e) {
                ...
                try {
                    ...
                    if (wpsclient) {
                        if (resText.data && paramStr.messageId)  // 如果发的数据是字符串化后的json对象，这里的resText.data就是一个json对象，可以输出自己想要的json数据
    ...
    return { WpsInvoke: WpsInvoke, WpsAddonMgr: WpsAddonMgr, version: "1.0.24" };
});